...
using Adp.Dotnet.Test.Roz.Api.Config;
using Adp.Dotnet.Test.Roz.Api.Extensions;
...
namespace Adp.Dotnet.Test.Roz.Api;
...
public static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        {
            config.SwaggerDoc("v1", new OpenApiInfo { Title = "Adp.Dotnet.Test.Roz", Version = "v1" });
        });
